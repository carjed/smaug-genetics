...
for(j in 1:6){
	categ<-orderedcats[j]
	p1a<-rrheat3(r5m[r5m$Category==categ,])
	 png(paste0(parentdir, "/images/rare_common_diff2", categ, ".png"),
...
trimcmd <- paste0("mogrify -trim ", parentdir, "/images/rare_common_diff*.png")
system(trimcmd)
