...
grep -Fwf  <(cut -f 2 /net/bipolar/jedidiah/mutation/reference_data/GoNL_DNMs2.txt) /net/bipolar/jedidiah/mutation/output/predicted/full/chr${chr}_full.txt | sed "s/$/\t1/" > /net/bipolar/jedidiah/mutation/reference_data/GoNL_DNMs2_chr${chr}_mu.txt
