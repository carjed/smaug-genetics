...
bedtools makewindows -g "$refdir/hg19.genome" -w 1000000 | grep -v "_" | sort -k 1,1 -k2,2n > "$refdir/genome.1000kb.sorted.bed"

bedtools makewindows -g "$refdir/hg19.genome" -w 100000 | grep -v "_" | sort -k 1,1 -k2,2n > "$refdir/genome.100kb.sorted.bed"

bedtools makewindows -g "$refdir/hg19.genome" -w 10000 | grep -v "_" | sort -k 1,1 -k2,2n > "$refdir/genome.10kb.sorted.bed"

bedtools makewindows -g "$refdir/hg19.genome" -w 3000000000 | grep -v "_" | sort -k 1,1 -k2,2n > "$refdir/genome.full.sorted.bed"
