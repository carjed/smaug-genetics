...
main_ident_out<-paste0(imgdir,"/chr",chr,"_",mac,"_dist_ident.png")
main_dodge_out<-paste0(imgdir,"/chr",chr,"_",mac,"_dist_dodge.png")
...
if (adj==1) {
	...
	#Plot counts and relative mutation rates
